...
(worldgdf.at[21, 'iso_a3'], worldgdf.at[43, 'iso_a3'], worldgdf.at[174, 'iso_a3']) = ('NOR', 'FRA', 'XKX') # adds Norway, France, Kosovo
...
while loopbool:
    ...
    if userinput == 'exit':
        loopbool = False
    elif userinput.isalpha() and len(userinput) == 3 and userinput in list(worldgdf['iso_a3']) and accum < 25:
...
randomvalslist = [random.random() + 1 if anyentry in userinputlist else None for anyentry in worldgdf['iso_a3']]
randomvalslist2 = [1 if anyentry in userinputlist else None for anyentry in worldgdf['iso_a3']]
worldgdf['randomvals'], worldgdf['randomvals2'] = randomvalslist, randomvalslist2

#global_conn.close()

worldgdf.plot(edgecolor = 'black', column = worldgdf['randomvals'], cmap = 'viridis', legend = True)
plt.figure(1)
worldgdf.plot(edgecolor = 'black', column = worldgdf['randomvals2'], cmap = 'viridis', legend = True)
plt.show()